// new hoook called useLocation
//  uselocation hook communicates with usenavigate hook to obtain state info sent via dynamic routing
// here uselocation is used to obtain uniq array of information for food clicked via menu page
